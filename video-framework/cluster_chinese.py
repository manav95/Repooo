...
import argparse
import shutil
predictor_path = os.getcwd() + "/video-framework/shape_predictor_68_face_landmarks.dat"
face_rec_model_path = os.getcwd() + "/video-framework/dlib_face_recognition_resnet_model_v1.dat"
#faces_folder_path = "/home2/rajib/face/test9"
result_dir=os.getcwd() + "/video-framework/Results/output"
